...
namespace _1dv607Design.view
{
    class ViewRenderer
    {
        ...
        public void Boats(List<string> boats)
        {
        ...
        public void MemberInfo(string member)
        {
            Console.Clear();
        ...
        public void MembersCompact(List<string> memberList)
        {
            Console.Clear();
        ...
        public void MembersVerbose(List<string> memberList)
        {
            Console.Clear();
            foreach (var member in memberList)
            {
